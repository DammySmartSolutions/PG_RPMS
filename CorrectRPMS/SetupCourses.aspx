<%@ Page Language="C#" Title="Courses Setup" ClientIDMode="Static" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SetupCourses.aspx.cs" Inherits="CorrectRPMS.SetupCourses" %>
  ...
  <asp:Label id="asplbl" runat="server"  BackColor="Blue" ForeColor="White" Font-Bold="true"  ></asp:Label> <br />
        ...
        <div class="row" style="position: relative; margin-top: 1%; left: 5%">
            ...
            <div class="col-3">
                ...
                <input type="text" id="txtcoursecode" runat="server" name="txtcoursecode" placeholder="course code" class="form-control" />
        ...
        <div class="row" style="position: relative; margin-top: 1%; left: 5%">
            <div class="col-3">
                <label for="txtcoursename" class="control-label" style="position: relative; float: right">Course Name:</label>

            </div>
            <div class="col-3">

                <input type="text" id="txtcoursename" runat="server" name="txtcoursename" placeholder="course name" class="form-control" />
        ...
        <div class="row" style="position: relative; margin-top: 0%; left: 20%" id="tablediv">
        ...
        <div class="row" style="position: relative; margin-top: 0%; left: 20%" id="tbldeptdiv">
    ...
    <asp:HiddenField runat="server" ClientIDMode="Static" ID="courseid" />
...
<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.12.1/js/jquery.dataTables.js"></script>--%>
    ...
    <!-- Bootstrap 4 -->
    <script src="Scripts/RPMS/SetupCourses.js"></script>
