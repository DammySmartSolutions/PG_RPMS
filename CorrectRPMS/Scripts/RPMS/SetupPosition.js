    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#table tbody').on('click', "#btnEdit", function () {
                ...
                id = Data["PositionID"]
                document.getElementById("txtposition").value = Data["Position"];



                Mainform.positionid.value = id
            ...
            $('#table tbody').on('click', "#btnDelete", function () {
                ...
                var Data = table.row(currentrow).data();
                ID = Data["PositionID"]
                var facultyname = Data["Position"];



                var Result = confirm("You are about to delete position " + facultyname)
                if (Result) {
...
function DeleteItem(ID) {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/Rpms/DeletePosition?id= " + ID + "",
        success: function (data) {
