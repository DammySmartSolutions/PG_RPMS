...
function LoadDataTable() {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/Rpms/LoadStudentStatus",
        success: function (data) {
            ...
            $('#table tbody').on('click', "#btnDelete", function () {
                ...
                var Data = table.row(currentrow).data();
                ID = Data["StatusID"]
                var facultyname = Data["Status"];



                var Result = confirm("You are about to delete student status " + facultyname)
                if (Result) {
...
function DeleteItem(ID) {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/Rpms/DeleteStudentStatus?id= " + ID + "",
        success: function (data) {
