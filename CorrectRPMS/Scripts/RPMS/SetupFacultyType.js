    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var datatableVariable = $('#table').DataTable({
                ...
                "columnDefs": [{ "width": "40%", "targets": 0 }, { "width": "5%", "targets": 1 }, { "width": "5%", "targets": 2 }],
                pageLength: 10,
                dom: "Bfrtip",
                buttons: [
            ...
            $('#table tbody').on('click', "#btnEdit", function () {
                ...
                id = Data["FacultyTypeID"]
                document.getElementById("txtfacultytype").value = Data["FacultyType"];

                document.getElementById("UpdateValue").value = Data["FacultyType"];


                Mainform.facultytypeid.value = id
            ...
            $('#table tbody').on('click', "#btnDelete", function () {
                ...
                var Data = table.row(currentrow).data();
                ID = Data["FacultyTypeID"]
                var facultyname = Data["FacultyType"];



                var Result = confirm("You are about to delete faculty type " + facultyname)
                if (Result) {
...
function DeleteItem(ID) {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/Rpms/DeleteFacultyType?id= " + ID + "",
        success: function (data) {
            alert("Faculty Type Deleted!");
            ID = 0;
            LoadDataTable();
