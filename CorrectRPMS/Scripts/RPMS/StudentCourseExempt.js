...
function LoadDataTable() {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/Rpms/LoadStudentCourseExempt",
        success: function (data) {
            ...
            var datatableVariable = $('#table').DataTable({
                ...
                "columnDefs": [{ "width": "10%", "targets": 0 }, { "width": "10%", "targets": 1 }, { "width": "20%", "targets": 2 }, { "width": "35%", "targets": 3 }, { "width": "5%", "targets": 4 }, { "width": "5%", "targets": 5 }],
                pageLength: 10,
                dom: "Bfrtip",
                buttons: [
            ...
            $('#table tbody').on('click', "#btnEdit", function () {
                ...
                id = Data["StudCourseExemptID"]
                document.getElementById("txtmatricno").value = Data["MatricNumber"];
                document.getElementById("txtcoursecode").value = Data["CourseCode"];
                ...
                Mainform.studcourseexemptID.value = id
            ...
            $('#table tbody').on('click', "#btnDelete", function () {
                ...
                var Result = confirm("You are about to delete course: " + coursecode + " exempted for student with matric number: " + matricno )
                if (Result) {
...
function DeleteItem(ID) {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/Rpms/DeleteStudentCourseExempt?id= " + ID + "",
        success: function (data) {
            alert("Course Exemption Deleted!");
            ID = 0;
            LoadDataTable();
