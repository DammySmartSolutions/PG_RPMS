    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#table tbody').on('click', "#btnEdit", function () {
                ...
                id = Data["RoleID"]
                document.getElementById("txtrole").value = Data["Roles"];



                Mainform.roleid.value = id
            ...
            $('#table tbody').on('click', "#btnDelete", function () {
                ...
                var Data = table.row(currentrow).data();
                ID = Data["RoleID"]
                var facultyname = Data["Roles"];



                var Result = confirm("You are about to delete role " + facultyname)
                if (Result) {
