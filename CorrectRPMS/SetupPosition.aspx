<%@ Page Language="C#" Title="Position Setup" ClientIDMode="Static" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SetupPosition.aspx.cs" Inherits="CorrectRPMS.SetupPosition" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%-- end of the   html panel div--%>
        ...
        <div class="row" style="position:relative; left:5%">
              ...
              <label for="txtposition" class="control-label"  style="position:relative; float:right">Position:</label>

                        </div>

             <div class="col-3">
                                <input type="text" id="txtposition" runat="server" name="txtposition"   class="form-control" required placeholder="HOD" />
     ...
     <asp:HiddenField runat="server" ClientIDMode="Static" ID="positionid" />
...
<!-- Bootstrap 4 -->
    ...
    <script src="Scripts/RPMS/SetupPosition.js"></script>
