<%@ Page Language="C#" Title="Semester Setup" ClientIDMode="Static" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SetupSemester.aspx.cs" Inherits="CorrectRPMS.SetupSemester" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%-- end of the   html panel div--%>
        ...
        <div class="row" style="position:relative; left:5%">
              ...
              <label for="txtsemester" class="control-label"  style="position:relative; float:right">Semester:</label>

                        </div>

             <div class="col-3">
                                <input type="text" id="txtsemester" runat="server" name="txtsemester"   class="form-control" required placeholder="Rain/Harmattan" />
     ...
     <asp:HiddenField runat="server" ClientIDMode="Static" ID="semesterid" />
...
<!-- Bootstrap 4 -->
    ...
    <script src="Scripts/RPMS/SetupSemester.js"></script>
