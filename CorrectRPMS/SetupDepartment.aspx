<%@ Page Language="C#" Title="Department Setup" ClientIDMode="Static" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SetupDepartment.aspx.cs" Inherits="CorrectRPMS.SetupDepartment" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%-- end of the   html panel div--%>
        ...
        <div class="row" style="position:relative; margin-top:2%; left:5%">
                 ...
                 <label for="ddlfaculty" class="control-label" style="position:relative; float:right">Faculty/College:</label>
                  ...
                  <div class="col-3">
                             ...
                             <asp:DropDownList ID="ddlfaculty" runat="server" CssClass="form-control" Width="77%"  ></asp:DropDownList>
             ...
             <div class="row" style="position:relative; margin-top:1%; left:5%">
                   <div class="col-3">
                                     <label for="txtdeptcode" class="control-label" style="position:relative; float:right">Department Code:</label>

                   </div>
                  <div class="col-3">
 
     
                           <input type="text" id="txtdeptcode" runat="server" name="txtdeptcode"  placeholder="Department code" class="form-control"  />
        ...
        <div class="row" style="position:relative; margin-top:1%; left:5%">
                   <div class="col-3">
                                     <label for="txtdept" class="control-label" style="position:relative; float:right">Department:</label>

                   </div>
                  <div class="col-3">
 
                   <input type="text" id="txtdept" runat="server" name="txtdept"  placeholder="Department name" class="form-control"  />
             ...
             <div class ="row" style="position:relative; margin-top:0%; left:5%"  id="tablediv">
            ...
            <div class ="row" style="position:relative; margin-top:0%; left:5%" id="tbldeptdiv" >
     ...
     <asp:HiddenField runat="server" ClientIDMode="Static" ID="deptid" />
...
<!-- Bootstrap 4 -->
    ...
    <script src="Scripts/RPMS/SetupDepartment.js"></script>
