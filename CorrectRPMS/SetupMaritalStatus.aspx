<%@ Page Language="C#"  Title="Marital Status Setup" ClientIDMode="Static" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SetupMaritalStatus.aspx.cs" Inherits="CorrectRPMS.SetupMaritalStatus" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%-- end of the   html panel div--%>
        ...
        <div class="row" style="position:relative; left:5%">
              ...
              <label for="txtmarital" class="control-label"  style="position:relative; float:right">Marital Status:</label>

                        </div>

             <div class="col-3">
                                <input type="text" id="txtmarital" runat="server" name="txtmarital"   class="form-control" required placeholder="Single/married" />
     ...
     <asp:HiddenField runat="server" ClientIDMode="Static" ID="maritalid" />
...
<!-- Bootstrap 4 -->
    ...
    <script src="Scripts/RPMS/SetupMarital.js"></script>
