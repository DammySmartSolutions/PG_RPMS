...
{
    public partial class SetupPosition : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("SetupPosition.aspx");
            }
            ...
            {
                ShowMessage("Please Enter Position");
                txtposition.Focus();
                return;
            }
            ...
            {
                facid = int.Parse(positionid.Value);
            }
            ...
            string position = txtposition.Value.ToUpper();


            var facultydetail = Db.tblPosition.Where(x => x.PositionID == facid).FirstOrDefault();
            try
            {
                if (facultydetail == null)
                {
                    ...
                    var NewFacultydetail = new tblPosition();

                    NewFacultydetail.Position = position;

                    Db.tblPosition.Add(NewFacultydetail);
                    Db.SaveChanges();
                ...
                else
                {
                    ...
                    facultydetail.Position = position;
